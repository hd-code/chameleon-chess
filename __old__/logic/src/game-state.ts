...
import { Player, isPlayer, arePlayersAlive, getNextPlayer } from "./player";
import { Role } from "./role";
import { hasKey, isArray } from "./type-guards";
 ...
 */
export function getPlayersAlive(gameState: GameState): {
