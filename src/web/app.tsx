...
export const App: FC = () => {
    ...
    return (
        <div className='hw-100 no-overflow flex center middle font-1 fz-140' ref={appRef}>
...
function useDimensions(): { height: number; width: number; appRef: (div: HTMLDivElement | null) => void } {
