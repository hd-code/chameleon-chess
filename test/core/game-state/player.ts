...
describe("core/game-state/player", () => {
  ...
  describe(arePlayersAlive.name, () =>
    it.each([
      ...
      [
        "red and yellow pawns",
        redYellowPawns,
        { 0: true, 1: false, 2: true, 3: false },
      ],
      [
        "green and blue pawns",
        greenBluePawns,
  ...
  describe(getNextPlayer.name, () =>
    it.each([
      ...
      [
        "red and yellow pawns, now red, then yellow",
        redYellowPawns,
        Color.red,
        Color.yellow,
      ],
      [
        "red and yellow pawns, now yellow, then red",
        redYellowPawns,
        Color.yellow,
        Color.red,
      ],
      [
        "red and yellow pawns, now green, then red",
        redYellowPawns,
        Color.green,
        Color.red,
      ],
      [
        "red and yellow pawns, now blue, then yellow",
        redYellowPawns,
        Color.blue,
        Color.yellow,
      ],
      [
        "green and blue pawns, now blue, then green",
        greenBluePawns,
        Color.blue,
        Color.green,
      ],
      [
        "green and blue pawns, now red, then blue",
        greenBluePawns,
        Color.red,
        Color.blue,
      ],
