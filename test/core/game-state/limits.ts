...
describe('core/game-state/limits', () => {
    describe(isLimits.name, () => {
        [
            ...
            { input: { minRow: 0, maxRow: 7, minCol: '0', maxCol: 7 }, expected: false },
            { input: { minRow: 0, maxRow: 0.5, minCol: 0, maxCol: 7 }, expected: false },
    ...
    describe(updateLimits.name, () => {
        [
            ...
            },
            {
                ...
                pawns: [{ player: 0, knightColor: 0, position: { row: 0, col: 0 } }],
                limits: { minRow: 0, maxRow: 7, minCol: 0, maxCol: 7 },
            ...
            },
            {
                ...
                pawns: [{ player: 0, knightColor: 0, position: { row: 3, col: 3 } }],
                limits: { minRow: 0, maxRow: 7, minCol: 0, maxCol: 7 },
