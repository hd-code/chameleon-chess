...
describe('core/ai/score', () => {
    ...
    describe(normalizeScore.name, () => {
        [
            { input: { 0: 1, 1: 1, 2: 1, 3: 1 }, expected: { 0: 0.25, 1: 0.25, 2: 0.25, 3: 0.25 } },
            { input: { 0: 0, 1: 1, 2: 0, 3: 0 }, expected: { 0: 0, 1: 1, 2: 0, 3: 0 } },
            { input: { 0: 0, 1: 1, 2: 1, 3: 0 }, expected: { 0: 0, 1: 0.5, 2: 0.5, 3: 0 } },
            { input: { 0: 4, 1: 1, 2: 2, 3: 3 }, expected: { 0: 0.4, 1: 0.1, 2: 0.2, 3: 0.3 } },
            { input: { 0: 5, 1: 5, 2: 5, 3: 5 }, expected: { 0: 0.25, 1: 0.25, 2: 0.25, 3: 0.25 } },
